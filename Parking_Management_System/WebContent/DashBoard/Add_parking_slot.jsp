...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed" ng-app="DashBoard_app" ng-controller="DashBoard_contr" ng-init="Rate_name_for_parking()">
<div class="wrapper">
  <!-- Navbar -->
   <!-- Navbar -->
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="Add_parking_slot.jsp" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Add Parking slot</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
           ...
           <!-- Horizontal Form -->
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Add Parking Slot</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal">
                <div class="card-body">
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Slot Name</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputEmail3" placeholder="Category Name" ng-model="slot_name">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputPassword3" class="col-sm-2 col-form-label">Rate Name</label>
                    <div class="col-sm-10">
                      <select class="form-control" ng-model="Rate_name">
                        <option ng-repeat="name in list_of_name_rate.Rate_name track by $index">{{name}}</option>
                      </select>
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <select class="form-control" ng-model="slot_status">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <select class="form-control" ng-model="slot_availability">
                ...
                <div class="card-footer">
                  <button class="btn btn-success swalDefaultSuccess" ng-click="manage_parking_fun()">Add Parking Slot</button>
                </div>
                <!-- /.card-footer -->
              </form>
            </div>
