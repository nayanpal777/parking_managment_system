...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="Toasts/toastr.css">
  <link rel="stylesheet" type="text/css" href="Toasts/toastr.min.css">
</head>
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed" ng-app="DashBoard_app" ng-controller="DashBoard_contr" ng-init="category_name_for_rate()">
<div class="wrapper">
  <!-- Navbar -->
   <!-- Navbar -->
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="add_Rate.jsp" class="nav-link active">
              ...
              <form class="form-horizontal">
                <div class="card-body">
                  <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Rate Name</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" placeholder="Rate Name" ng-model="Rate_name">
                    </div>
                  </div>
                  <div class="form-group row">
                   <label class="col-sm-2 col-form-label">Category</label>
                    <div class="col-sm-10">
                      <select class="form-control" ng-model="Category">
                        <option ng-repeat="name in Rate_for_data_name track by $index">{{name}}</option>
                      </select>
                    </div>
                  </div>
                  <div class="form-group row">
                   <label class="col-sm-2 col-form-label">Type</label>
                    <div class="col-sm-10">
                      <select class="form-control" ng-model="Rate_type">
                        <option>Fixed</option>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" placeholder="Rate" ng-model="Rate">
                    </div>
                  </div>
                  <div class="form-group row">
...
<script src="dist/js/pages/dashboard2.js"></script>
 <script type="text/javascript" src="Toasts/jquery-3.4.1.min.js"></script>
   <script type="text/javascript" src="Toasts/toastr.min.js"></script>
