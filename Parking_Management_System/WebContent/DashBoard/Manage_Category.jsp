...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed" ng-app="myapp" ng-controller="mycontroller" ng-init="select_category()">
<div class="wrapper">
  <!-- Navbar -->
   <!-- Navbar -->
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="Manage_Category.jsp" class="nav-link  active">
                  <i class="nav-icon far fa-circle text-danger"></i>
                  <p>Manage Category</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
	...
	<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-2">
            <a href="add_category.jsp"><button class="btn btn-block btn-primary"><i class="fa fa-plus"> Add Category</i></button></a>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
	            	...
	            	<div class="row" style="text-align: center;">
	            		<div class="col-3">
	            			<table class="table table-hover">
	            				<tr ng-repeat="x in catetory_data.category_id track by $index">
	            					<td>{{x}}</td>
	            				</tr>
	            			</table>		
	            		</div>
	            		<div class="col-3">
	            			<table class="table table-hover">
	            				<tr ng-repeat="x in catetory_data.category_name track by $index">
	            					<td>{{x}}</td>
	            				</tr>
	            			</table>
	            		</div>
	            		<div class="col-3">
	            			<table class="table table-hover">
	            				<tr ng-repeat="x in catetory_data.category_status track by $index">
	            					<td>{{x}}</td>
	            				</tr>
	            			</table>		
	            		</div>
	            		<div class="col-3">
	            			<table class="table table-hover">
	            				<tr ng-repeat="x in catetory_data.category_id track by $index">
	            					<td hidden="">{{x}}</td>
	            					<td><button ng-click="update_category(x)" class="btn btn-outline-success btn-sm" data-toggle="modal" data-target="#myModal"><i class="fas fa-edit"> Edit</i></button> <button class="btn btn-outline-danger btn-sm" ng-click="delete_category(x)"><i class="fa fa-trash"> Delete</i></button></td>
	            				</tr>
	            			</table>		
				    ...
				    <div class="modal-content">
					 ...
					 <form class="form-horizontal">
		                ...
		                <div class="form-group row">
		                    ...
		                    <div class="col-sm-10">
		                      <input type="text" class="form-control" id="inputEmail3" disabled="disabled" value={{id}}>
		                    </div>
		                  </div>
		                  <div class="form-group row">
		                    <label for="inputPassword3" class="col-sm-2 col-form-label">Status</label>
		                    <div class="col-sm-10">
		                      <select class="form-control" ng-model="category_status2">
		                        <option selected="selected">Active</option>
		                        <option>Inactive</option>
		                      </select>
		                    </div>
		                  </div>
		                  <button class="btn btn-success swalDefaultSuccess" ng-click="category_submit()">Save Change</button>
		                </div>
